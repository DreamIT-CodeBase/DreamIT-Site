    ...
    <section className="container   xl:py-16 lg:py-16 md:py-16 sm:py-8 xs:py-8  bg-white">
      <div className=" flex flex-col lg:flex-row xl:gap-16 lg:gap-16 md:lg-8 xs:gap-8 items-center">
        <div className="lg:w-1/2 space-y-4">
          ...
          <p className="xl:text-20 lg:text-16 md:text-16 sm:text-[14px] xs:text-[14px] text-[#072032] xl:max-w-[40rem]">
          ...
          <p className="xl:text-20 lg:text-16 md:text-16 sm:text-[14px] xs:text-[14px] xl:leading-[26.04px] font-400 text-[#072032] xl:max-w-[40rem]">
          ...
          <p className="xl:text-20 lg:text-16 md:text-16 xl:leading-[26.04px] sm:text-[14px] xs:text-[14px] font-400 text-[#072032] xl:max-w-[40rem]">
