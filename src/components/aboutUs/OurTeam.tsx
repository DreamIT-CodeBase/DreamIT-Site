  ...
  return (
    <div>
      <section className="bg-black text-white container pt-60 pb-60">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 cursor-pointer">
            ...
            >
              <div className="absolute inset-0 p-6 flex flex-col justify-between transition-all duration-300">
                ...
                <div
                  ...
                  className="absolute inset-0   bg-cover bg-center transition-all duration-300 before:content-[''] before:absolute before:inset-0 before:bg-[#072032E8] group-hover:before:opacity-100 before:opacity-0 before:transition-all before:duration-300"
                ></div>

                {/* Content that appears on hover */}
                <div className="absolute bottom-[30px] pr-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="flex justify-between">
                    <h3 className="text-34 font-semibold text-white">
                      {member.name}
                    </h3>
                    <img
                      className="h-[50px]"
                ...
                <div className="absolute bottom-6 left-6 right-6 group-hover:opacity-0 group-hover:translate-y-6 transition-all duration-300">
                  <div className="flex justify-between">
                    <h3 className="text-34 font-bold text-white transition-colors">
                      {member.name}
                    </h3>
                    <img
                      className="h-[50px]"
                  ...
                  <div className="relative px-5">
                    <span className="absolute top-1/2 left-1 transform -translate-y-1/2 w-[10px] h-[10px] bg-[#00A9FF] rounded-full"></span>
                    <span className="text-[#7DC1E9] text-center font-medium lg:text-[22px]">
                      {member.title}
                    </span>
                  </div>
                </div>
