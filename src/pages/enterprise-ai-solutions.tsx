  ...
  sections: [
    {
      ...
      title: "Owning Outcomes: The Future of Enterprise AI",
      content: `
        <p>The global landscape is led by an essential shift from the age of assistive Artificial Intelligence to the age of the Agentic AI Enterprise Solutions. This transition marks the departure of the "input-output" architecture of re-active chatbots toward a future where Autonomous AI coworkers understand, reason, and execute complex, multi-step workflows with minimal human oversight using Reasoning Agents.</p>
        <p>Dream IT Consulting Private Limited, a premier technology consultancy, uses the complete Microsoft AI stack to deliver reliable, governed, responsible, production grade Agentic AI Solutions. We provide Enterprise AI Consulting Services.</p>
        <p>In the past years, the rapid adoption of Microsoft 365 Copilot and Large Language Models (LLMs) provided significant first productivity gains in drafting and summarization text, gathering information and drafting good passages; however, many organizations have met a Plateau, where productivity gains have levelled off as human coordination with AI is still the primary execution bottleneck.</p>
        <p>The next phase of AI transformation is not about implementing better chatbots but about creating autonomous production AI systems that own business outcomes rather than just answering questions.</p>
      `,
    },
  ],
};
